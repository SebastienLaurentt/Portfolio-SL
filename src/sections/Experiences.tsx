  ...
  if (activeButton === 'PhD Student') {
    sectionContent = (
      <div className="">
        ...
        <img src={brainlogo} alt="An illustration of researchers doing brain research. (Copyright @ https://fr.freepik.com/vecteurs-libre/illustration-concept-chimie-du-cerveau_29654747.htm#&position=2&from_view=user)" className="mt-4 md:mt-8 h-40 md:h-80 mx-auto" />
      </div>
    );
    ...
    sectionContent = (
      <>
        ...
        <img src={carlogo} alt="An illustration of an individual in a car without a steering wheel because it is an autonomous vehicle. (Copyright @ https://fr.freepik.com/vecteurs-libre/illustration-concept-voiture-autonome_19184615.htm#&position=1&from_view=user)" className="mt-4 md:mt-8 h-40 md:h-80 mx-auto" />
      </>
    );
    ...
    sectionContent = (
      <>
        ...
        <img src={computerlogo} alt="An illustration of a laptop used for programming. (Copyright @ https://fr.freepik.com/vecteurs-libre/illustration-concept-codage-main_21864184.htm#&position=0&from_view=user) " className="mt-4 md:mt-12 h-40 md:h-80 mx-auto" />
      </>
    );
  }
